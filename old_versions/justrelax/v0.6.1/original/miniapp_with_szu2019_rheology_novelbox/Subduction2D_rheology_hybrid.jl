...
function init_rheology_nonNewtonian_plastic_litho_szu2019()
    #dislocation laws
    disl_wet_olivine = SetDislocationCreep(Dislocation.wet_olivine1_Hirth_2003)
    # diffusion laws
    diff_wet_olivine = SetDiffusionCreep(Diffusion.wet_olivine_Hirth_2003)
...
function init_rheology_nonNewtonian_plastic_litho_astheno_szu2019()
    #dislocation laws
    disl_wet_olivine = SetDislocationCreep(Dislocation.wet_olivine1_Hirth_2003)
    # diffusion laws
    diff_wet_olivine = SetDiffusionCreep(Diffusion.wet_olivine_Hirth_2003)
    ...
    return init_rheologies_litho_astheno_szu2019(lithosphere_rheology)
end

function init_rheology_nonNewtonian_plastic_litho_astheno_crust_szu2019()
    #dislocation laws
    disl_wet_olivine = SetDislocationCreep(Dislocation.wet_olivine1_Hirth_2003)
    # diffusion laws
    diff_wet_olivine = SetDiffusionCreep(Diffusion.wet_olivine_Hirth_2003)
    ...
    return init_rheologies_litho_astheno_crust_szu2019(lithosphere_rheology)
end
...
function init_rheologies_litho_astheno_szu2019(lithosphere_rheology)
    # common physical properties
    α = 2.4e-5 # 1 / K
    Cp = 750    # J / kg K
    # Define rheolgy struct
...
function init_rheologies_litho_astheno_crust_szu2019(lithosphere_rheology)
    #dislocation laws
    disl_wet_olivine = SetDislocationCreep(Dislocation.wet_olivine1_Hirth_2003)
    # diffusion laws
    diff_wet_olivine = SetDiffusionCreep(Diffusion.wet_olivine_Hirth_2003)
    ...
    return rheology = (
        ...
        SetMaterialParams(;
            Phase = 3,
            Density = ConstantDensity(; ρ = 3e3),
            HeatCapacity = ConstantHeatCapacity(; Cp = Cp),
            Conductivity = ConstantConductivity(; k = 2.5),
            CompositeRheology = CompositeRheology((
                ConstantElasticity(; G=2.5e10, ν = 0.45),
                DislocationCreep(;
