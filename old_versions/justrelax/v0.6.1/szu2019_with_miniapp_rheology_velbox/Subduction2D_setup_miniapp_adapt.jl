...
function GMG_subduction_2D_with_coords(
    ...
    add_polygon!(
        ...
        phase=ConstantPhase(2), # NOTE: Changed this visualisation field 23 January 2026 to relieve size of Rheology tuple
    )
    ...
    add_polygon!(
        ...
        Temp,
        Grid2D;
        xlim=(920, 1035, 1140, 1155, 1050, 970),
        zlim=(-25, -80, -130, -130, -80, -38),
        phase=ConstantPhase(5) #4),#Making phases contiguous (28 jan, v0.76)
    )
    ...
    add_polygon!(
        ...
        phase=ConstantPhase(3),# 5)#Making phases contiguous (28 jan, v0.76)
    )
    ...
    add_polygon!(
        ...
        phase=ConstantPhase(3)# 6)#Making phases contiguous (28 jan, v0.76)
    )
    ...
    add_polygon!(
        ...
        zlim=(-8, -19.5, -11.5, -8),
        phase=ConstantPhase(3) # 7),#Making phases contiguous (28 jan, v0.76) 
    )
    add_polygon!(
        Phases,
        Temp,
    ...
    add_polygon!(
        ...
        zlim=(-23, -38, -38, -23),
        phase=ConstantPhase(3) # 7),#Making phases contiguous (28 jan, v0.76)  # NOTE: Changed this visualisation field 23 January 2026 to relieve size of Rheology tuple
    )
    ...
    add_polygon!(
        ...
        zlim=(-8, -12.5, -19.5, -8),
        phase=ConstantPhase(3) # 9), #Making phases contiguous (28 jan, v0.76)
    )
    ...
    add_polygon!(
        ...
        phase=ConstantPhase(3) # 9), #Making phases contiguous (28 jan, v0.76) # NOTE: Changed this visualisation field 23 January 2026 to relieve size of Rheology tuple
    )
    ...
    add_polygon!(
        ...
        phase=ConstantPhase(5)# 5),#Making phases contiguous (28 jan, v0.76)
    )
