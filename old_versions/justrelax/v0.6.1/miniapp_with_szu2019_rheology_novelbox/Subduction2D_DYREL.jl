...
include("Subduction2D_setup_hybrid.jl")
include("Subduction2D_rheology_hybrid.jl")
...
function main(li, origin, phases_GMG, igg; nx = 16, ny = 16, figdir = "figs2D", do_vtk = false)
    ...
    rheology = init_rheology_nonNewtonian_plastic_litho_szu2019()
    # rheology = init_rheology_nonNewtonian_plastic_szu2019astheno_crust()
