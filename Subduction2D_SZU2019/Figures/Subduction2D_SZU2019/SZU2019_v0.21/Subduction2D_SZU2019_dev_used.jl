...
function main(li, origin, phases_GMG, igg; nx=16, ny=16, figdir="figs2D", do_vtk=false)
    ...
    dt = 0.2 * 10.0e3 * 3600 * 24 * 365 # diffusive CFL timestep limiter
    # ----------------------------------------------------
    ...
    for i in (ny+2)-10:(ny+2)-5
        ...
        # push!(nodes_boundary_box, 13 + i * 65)
        # push!(nodes_boundary_box, 14 + i * 65)
...
figdir = "Subduction2D_SZU2019/Figures/Subduction2D_SZU2019/SZU2019_v0.21"
n = 32 * 2
nx, ny = n * 2, n
