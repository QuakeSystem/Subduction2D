...
function GMG_subduction_2D(nx, ny)
    ...
    add_polygon!(
        ...
        zlim=(-8, -12.5, -19.5, -8),
        phase=ConstantPhase(6),###!!!!!DEBUG!!!!!!# √GeophysicalModelGenerator.jl/src/Setup_geometry.jl
        # T=LinearTemp(Ttop=20, Tbot=Tbot)
    )
    ...
    add_polygon!(
        ...
        phase=ConstantPhase(6), ###!!!!!DEBUG!!!!!!# NOTE: Changed this visualisation field 23 January 2026 to relieve size of Rheology tuple
        # T=LinearTemp(Ttop=20, Tbot=Tbot)
    )
