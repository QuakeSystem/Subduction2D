...
figdir = "Subduction2D_SZU2019/Figures/Subduction2D_SZU2019/SZU2019_v0.24"
n = 32 * 2
nx, ny = n * 2, n
...
dt = 0.01 * 10.0e3 * 3600 * 24 * 365 # diffusive CFL timestep limiter
# ----------------------------------------------------
...
if it == 1 || rem(it, 10) == 0
    ...
    ax5 = Axis(fig[1, 5], aspect=ar, title="log10(η_vep)")
    ...
    h5 = heatmap!(ax5, xci[1] .* 1.0e-3, xci[2] .* 1.0e-3, Array(log10.(stokes.viscosity.η_vep)), colormap=:batlow)
