...
function main(li, origin, phases_GMG, igg; nx=16, ny=16, figdir="figs2D", do_vtk=false)
    ...
    rheology = init_rheology_nonNewtonian_plastic() # JustRelax.jl/miniapps/subduction/2D/Subduction2D_rheology.jl
...
figdir = "Figures/Subduction2D_SZU2019/SZU2019_v0.3"
n = 32 # *4
nx, ny = n * 2, n
