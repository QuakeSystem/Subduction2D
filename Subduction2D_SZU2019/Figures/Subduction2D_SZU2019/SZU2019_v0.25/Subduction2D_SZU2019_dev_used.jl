...
figdir = "Subduction2D_SZU2019/Figures/Subduction2D_SZU2019/SZU2019_v0.25"
n = 32 * 2
nx, ny = n * 2, n
...
for i in (ny+2)-15:(ny+2)-10
    ...
    # println("xcoord, y coord:", grid_vxi[1][1][15], grid_vxi[1][2][i])
...
if it == 1 #|| rem(it, 10) == 0
    ...
    h4 = heatmap!(ax4, xci[1] .* 1e-3, xci[2] .* 1e-3, Array(log10.(stokes.ε.II)), colormap=:batlow)
